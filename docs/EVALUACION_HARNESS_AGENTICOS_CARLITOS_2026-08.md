...
4. **`BACKLOG-MODEL-SWAP-BENCH` [CERRADO 2026-08-20]:** Benchmark de swap de modelo (Qwen3-Coder-30B-A3B-Instruct MoE vs Devstral-Small-2-24B-Instruct-2512 denso) ejecutado sobre las mismas 15 tareas de OptiFierro-V2, fovea-selectivo por tarea como constante. Ambos candidatos 15/15 OK y tool-calling verificado; MoE resultó 57% más rápido en tiempo de pared que el denso (68.0s vs 106.9s promedio por tarea) pese a tener más parámetros totales — confirma con datos que MoE activo-por-token es el factor dominante de velocidad, no el conteo total de parámetros. Ninguno reemplazó producción en esta pasada (falta evaluación de calidad de respuesta, fuera de alcance). Ver `docs/evidencia/REPORTE_BENCHMARK_MODEL_SWAP_2026-08-19.md` y LOG_CAMBIOS_2026.md (2026-08-19/20) para el RCA del fallo de la sesión nocturna previa.
